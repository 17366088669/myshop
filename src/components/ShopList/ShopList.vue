	...
	<div class="home_shop_list">
		...
		<div class="shop_container">
			<ul class="shop_list" v-if="shopsArr.length">
				<li class="shop_li border-1px" v-for="(shop,index) in shopsArr" :key="index" @click="$router.push('/shop')">
					<a>
						<div class="shop_left">
							<img class="shop_img" :src="shop.imgSrc">
						</div>
	...
	export default {
		...
		computed: {
			...
			shopsArr () {
				...
				const Arr = []
				shops.forEach((s, i) => {
					s['imgSrc'] = require(`./images/shop/${i}.jpg`)
					Arr.push(s)
				})
				return Arr
			}
